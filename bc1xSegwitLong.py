...
def seek(r, df_handler):
	...
	while True:
		...
		pub = pub + '\n'
		filename = '/data/BitBruteForce-Wallet-Compressed-Address/top3M_bc_long.txt' #<----------------------------------------------------------change here Dir
...
if __name__ == '__main__':
	jobs = []
	df_handler = pd.read_csv(open('/data/BitBruteForce-Wallet-Compressed-Address/top3M_bc_long.txt', 'r'))  #<--------------------------------------------------------change here Dir
